...
class Runner {
  ...
  async init(deploymentSigner?: Signer): Promise<this> {
    ...
    // const accountDeployer = await DeterministicDeployer.getAddress(
    ...
    // for the index: 1705041357699 addr : 0xEba555C133D2AcC0118a9F08877e80237180b8b2
  ...
  async runUserOp(target: string, data: string): Promise<void> {
    const userOp = await this.accountApi.createSignedUserOp({ target, data });
...
async function main(): Promise<void> {
  ...
  // const accountOwner = new Wallet("0x3135cb20a7175a5e93249cb5bed80165be85fb3a");
  const privateKey =
    "0x7777777777777777777777777777777777777777777777777777777777777777";
  // for wallet "0xc17D95d11460B4d2F5270b0bC79BB5ADa03F375c"

  // console.log("Private Key : --> ", privateKey);
  const accountOwner = new Wallet(privateKey, provider);

  console.log("Account Owner :-->", accountOwner.getAddress());
  ...
  const dest = "0x5db8a37355c3ec7db5e6b888037948960924ce17";
  // const dest = addr;

  const abi =
    "mintNft(uint256,uint256,uint256,string,uint256,uint256,uint256,uint256,uint256)";

  // const params = [10687, 250, 1000, "0x1234", 1, 1, 4, 1705084199, 1000];

  // 10687, 250, 1000, "0x1234",1,1,4, 1705084199, 1000;

  // Encode the function call
  // const data = utils.defaultAbiCoder.encode([abi], [params]);

  const data =
    "";
